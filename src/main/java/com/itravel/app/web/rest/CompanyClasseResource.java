...
public class CompanyClasseResource {
    ...
    @Timed
    public ResponseEntity<CompanyClasse> createCompanyClasse(@Valid @RequestBody CompanyClasse companyClasse) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<CompanyClasse> updateCompanyClasse(@Valid @RequestBody CompanyClasse companyClasse) throws URISyntaxException {
