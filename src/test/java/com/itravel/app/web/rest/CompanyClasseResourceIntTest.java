...
import com.itravel.app.repository.CompanyClasseRepository;
import com.itravel.app.repository.search.CompanyClasseSearchRepository;
...
public class CompanyClasseResourceIntTest {
    ...
    public void createCompanyClasse() throws Exception {
        ...
        assertThat(testCompanyClasse.getCompany()).isEqualTo(DEFAULT_COMPANY);
        assertThat(testCompanyClasse.getClasse()).isEqualTo(DEFAULT_CLASSE);
    ...
    public void checkCompanyIsRequired() throws Exception {
        int databaseSizeBeforeTest = companyClasseRepository.findAll().size();
        // set the field null
        companyClasse.setCompany(null);

        // Create the CompanyClasse, which fails.
        ...
        List<CompanyClasse> companyClasseList = companyClasseRepository.findAll();
        assertThat(companyClasseList).hasSize(databaseSizeBeforeTest);
    }
    ...
    public void updateCompanyClasse() throws Exception {
        ...
        CompanyClasse testCompanyClasse = companyClasseList.get(companyClasseList.size() - 1);
        assertThat(testCompanyClasse.getCompany()).isEqualTo(UPDATED_COMPANY);
        assertThat(testCompanyClasse.getClasse()).isEqualTo(UPDATED_CLASSE);
