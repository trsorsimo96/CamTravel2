...
import com.itravel.app.repository.CompanyRepository;
import com.itravel.app.repository.search.CompanySearchRepository;
...
public class CompanyResourceIntTest {
    ...
    private static final Integer DEFAULT_SYSTEM_COMMISION = 1;
    private static final Integer UPDATED_SYSTEM_COMMISION = 2;
    ...
    public void getAllCompanies() throws Exception {
        ...
        restCompanyMockMvc.perform(get("/api/companies?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].systemCommision").value(hasItem(DEFAULT_SYSTEM_COMMISION)));
    }
    ...
    public void getCompany() throws Exception {
        ...
        restCompanyMockMvc.perform(get("/api/companies/{id}", company.getId()))
            ...
            .andExpect(jsonPath("$.systemCommision").value(DEFAULT_SYSTEM_COMMISION));
    }
