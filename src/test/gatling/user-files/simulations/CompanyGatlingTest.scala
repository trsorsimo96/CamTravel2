...
class CompanyGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Company entity")
        ...
        .repeat(2) {
            ...
            .post("/api/companies")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "code":"SAMPLE_TEXT", "name":"SAMPLE_TEXT", "image":null, "tel":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "omNumber":"SAMPLE_TEXT", "momoNumber":"SAMPLE_TEXT", "systemCommision":"0"}""")).asJSON
            .check(status.is(201))
